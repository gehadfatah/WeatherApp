...
import com.example.godaa.sunshine.data.WeatherDpHelper;
import com.example.godaa.sunshine.test.TestUtilities.*;
import java.util.HashSet;

/**
 * Created by godaa on 11/03/2017.
 */
public class TestDp extends AndroidTestCase {
    public static final String LOG_TAG = TestDp.class.getSimpleName();

    // Since we want each test to start with a clean slate
    void deleteTheDatabase() {
        mContext.deleteDatabase(WeatherDpHelper.DATABASE_NAME);
    }
    ...
    public void testCreateDb() throws Throwable {
        ...
        mContext.deleteDatabase(WeatherDpHelper.DATABASE_NAME);
        SQLiteDatabase db = new WeatherDpHelper(
    ...
    */
    public long testLocationTable() {
        ...
        ContentValues northPoleLocationData = TestUtilities.createNorthPoleLocationValues();
        ...
        // query if you like)
        TestUtilities.  validateCurrentRecord("Record does not match ContentValues", c, northPoleLocationData);
    ...
    public void testWeatherTable() {
        ...
        TestUtilities. validateCurrentRecord("Weather record is not what was expected", c, weatherData);
